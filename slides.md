...
<!-- .slide: data-background-image="img/christin.jpeg"data-background-size="contain"-->
<!-- .slide: class="hover"-->
...
Ce sont ces trois points que je vais rapidement expliciter.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

<!-- .slide: data-background-image="img/hieroglyphe.jpeg" data-background-size="contain"-->
